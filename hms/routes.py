...
def createPatient():
    ...
    if form.validate_on_submit():
        patient = Patient(ssn=form.patient_ssn_id.data, name=form.patient_name.data, age=form.patient_age.data , date_of_joining=form.date_of_admission.data , room_type=form.type_of_bed.data , address=form.address.data , state=form.state.data , city=form.city.data)
