...
class DiagnosticIssuedToPatient(db.Model):
    ...
    # diagnostic = db.relationship("Diagnostic")
...
class Patient(db.Model):
    ...
    # medicines = db.relationship(MedicineIssuedToPatient, backref=db.backref('patients'))
    # diagnostics = db.relationship(DiagnosticIssuedToPatient, backref=db.backref('patients'))
